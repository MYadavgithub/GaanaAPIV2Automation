...
public class RecommendedTracks extends BaseUrls{
    ...
    private static Logger log = LoggerFactory.getLogger(RecommendedTracks.class);
    ...
    public void createRecoTrackReq(String track_id){
        String url = BASEURL+Endpoints.RECO_TRACKS+track_id;
        URLS.add(url);
