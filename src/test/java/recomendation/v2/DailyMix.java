...
public class DailyMix {
    ...
    private static Logger LOG = LoggerFactory.getLogger(DailyMix.class);
    final static String JIRA_ID = "https://timesgroup.jira.com/browse/GAANA-45485";
    final static String REPROTING_FEATURE = "DailyMix api content validations.";
    ...
    public void createDailyMixReqAndValidateResponse(String device_id){
        SoftAssert softAssert = new SoftAssert();
        String device_md5 = CommonUtils.md5(device_id);
        String url = BASEURL+Endpoints.DAILY_MIX+device_md5;
        ...
        if(track_ids.length > 0 && !track_ids[0].equals("")){
            ...
            LOG.warn(this.getClass()+" for device_id : "+device_id+" and Url : "+url+"\n no data found...");
        }

        softAssert.assertAll();
        if(API_CALL == MAX_CALL-1)
            LOG.info(this.getClass()+" DailyMix api validated succuessfully.");
