...
public class Constants{
    ...
    public final static int AS_INVOCATION_COUNT = 1001;
    ...
    public static String EMAIL_CC_LIST = "rohit.ranjan@gaana.com, manish.pandey@gaana.com, c-abhishek.gupta@gaana.com";
