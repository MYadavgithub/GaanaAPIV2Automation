...
public class Constants{
    ...
    public final static int AS_INVOCATION_COUNT = 5;
    ...
    public static String EMAIL_CC_LIST = "manish.pandey@gaana.com, c-ritvik.sharma@gaana.com, namisha.negi@gaana.com";
