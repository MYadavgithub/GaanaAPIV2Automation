...
public class RecommendedTrackPojo {
    ...
    public RecommendedTrackPojo() {
    }

    public RecommendedTrackPojo(int iid, String ti, String aw, String sti, String[] lang, String ty, String fty,
